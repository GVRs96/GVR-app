...
function ReportView({ orders }) {
  ...
  return (
    <div style={{flex:1,overflowY:"auto",WebkitOverflowScrolling:"touch",background:"#0A0A0B",paddingBottom:80}}>
      {/* ── Header ── */}
...
function AnalyticsView({ orders }) {
  ...
  return (
    <div style={{flex:1,display:"flex",flexDirection:"column",minHeight:0,overflow:"hidden"}}>
      ...
      {/* ── CONTENT ── */}
      <div style={{flex:1,overflowY:"auto",WebkitOverflowScrolling:"touch",padding:"20px 16px 80px",background:"#0A0A0B"}}>
...
function DebtsView({ orders, debts, setDebts }) {
  ...
  return (
    <div style={{flex:1,overflowY:"auto",WebkitOverflowScrolling:"touch",padding:"18px 20px 80px"}}>
      <div style={{ marginBottom: 16 }}>
...
function ListTab({ leads, onUpdate, onDelete, sheetsUrl }) {
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",flex:1,minHeight:0}}>
      ...
      <div style={{flex:1,overflowY:"auto",WebkitOverflowScrolling:"touch",padding:"10px 18px 80px",display:"flex",flexDirection:"column",gap:6}}>
        {filtered.length===0 && (
...
function doPost(e) {
  ...
  return (
    <div style={{padding:"20px 18px 80px",overflowY:"auto",WebkitOverflowScrolling:"touch",flex:1}}>
      ...
      {STATUSES.map(col => {
        ...
        return (
          ...
          >
            ...
            {/* Cards */}
            <div style={{
              flex:1,overflowY:"auto",WebkitOverflowScrolling:"touch",padding:"10px 10px 60px",
