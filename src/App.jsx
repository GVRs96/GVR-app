...
function ListTab({ leads, onUpdate, onDelete, sheetsUrl }) {
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",flex:1,minHeight:0}}>
      ...
      <div style={{flex:1,overflowY:"auto",WebkitOverflowScrolling:"touch",padding:"10px 18px 80px",paddingBottom:"calc(120px + env(safe-area-inset-bottom))",display:"flex",flexDirection:"column",gap:6}}>
        {filtered.length===0 && (
